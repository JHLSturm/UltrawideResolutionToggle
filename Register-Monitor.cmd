...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ". ""%LOC%""; [Console]::OutputEncoding = [System.Text.UTF8Encoding]::new(); Write-Host; Write-Host (Get-AppText -Key 'RegisterCmdHint'); Write-Host"
